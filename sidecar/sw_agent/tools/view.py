...
@tool(
    ...
    "Switch the view to a standard orientation for inspection or screenshot (= Standard View; ShowNamedView2 + ViewZoomtofit2).",
...
@tool(
    "zoom_to_fit",
    "Zoom so the entire model fills the view (= Zoom to Fit; ViewZoomtofit2).",
    params={},
    category="view",
)
